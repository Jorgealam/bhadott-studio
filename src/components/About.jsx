...
const pillars = [
  ...
  },
  {
    icon: Wifi,
    title: "Remote-First",
    description: "Independent creative studio operating remotely with distributed tools and global digital delivery.",
    color: "violet",
  },
  {
    icon: Package,
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="max-w-3xl mx-auto text-slate-400 text-base sm:text-lg leading-relaxed px-2">
            <span className="text-blue-400 font-semibold">BHADOTT Studio</span> is a creative technology studio
            focused on games, AI and premium digital experiences. From systems and apps to immersive 3D worlds —
            we build ambitious projects with a strong identity, designed to reach a global audience from Brazil.
          </p>
        </motion.div>
